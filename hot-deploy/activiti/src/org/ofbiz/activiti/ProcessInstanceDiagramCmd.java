...
public class ProcessInstanceDiagramCmd implements Command<InputStream> {
    ...
    //private ActivitiProcessEngineFactory processEngine;

    private HistoryService historyService;

    public ProcessInstanceDiagramCmd(String processInstanceId, RuntimeService runtimeService, RepositoryService repositoryService,HistoryService historyService) {
    ...
    public InputStream execute(CommandContext commandContext) {
        ...
        Context.setProcessEngineConfiguration((ProcessEngineConfigurationImpl) ActivitiProcessEngineFactory.getProcessEngine().getProcessEngineConfiguration());
        ...
        InputStream imageStream = new DefaultProcessDiagramGenerator()/*.generateDiagram(bpmnModel, "png", activeActivityIds,
                highLightedFlows);*/
        	.generateDiagram(bpmnModel, "png",activeActivityIds,highLightedFlows, "宋体", "宋体", null,1.0);
