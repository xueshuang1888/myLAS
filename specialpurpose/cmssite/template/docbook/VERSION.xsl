...
<xsl:param name="VersionFileURL">$URL: http://svn.apache.org/repos/asf/ofbiz/branches/release15.12/specialpurpose/cmssite/template/docbook/VERSION.xsl $</xsl:param>
